...
import { SELECT_TOOL_DRAWING_ITEM, UPDATE_DRAWING_ITEM, END_DRAWING_ITEM, BEGIN_DRAGGING_ITEM, UPDATE_DRAGGING_ITEM, END_DRAGGING_ITEM, BEGIN_ROTATING_ITEM, UPDATE_ROTATING_ITEM, END_ROTATING_ITEM, SELECT_ITEM, UPDATE_ITEM } from "../constants";
...
export default function (state, action) {
  switch (action.type) {
    ...
    case BEGIN_DRAGGING_ITEM:
      ...
      return Item.setJsProperties(state, action.layerID, action.itemID, action.properties).updatedState;
