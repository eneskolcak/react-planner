...
exports.default = function (state, action) {
  switch (action.type) {
    ...
    case _constants.SET_PROPERTIES_BY_ITEMID:
      state = state.merge({
      ...
      return _export2.Project.setPropertiesByItemId(state, state.getIn(["scene", "selectedLayer"]), action.itemID, action.properties).updatedState;
