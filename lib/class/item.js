...
var Item = function () {
  ...
  _createClass(Item, null, [{
    ...
    value: function create(state, layerID, type, x, y, width, height, rotation, newProperties) {
      ...
      var properties = new _immutable.Map(_extends({}, newProperties));
    ...
    value: function updateDrawingItem(state, layerID, x, y, newProperties) {
      if (state.hasIn(["drawingSupport", "currentID"])) {
        ...
        var _create = this.create(state, layerID, state.getIn(["drawingSupport", "type"]), x, y, 200, 100, 0, _extends({}, newProperties)),
